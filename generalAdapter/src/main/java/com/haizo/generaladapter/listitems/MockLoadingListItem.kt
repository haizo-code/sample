...
class MockLoadingListItem constructor(
    override val viewHolderContract: ViewHolderContract = MainViewHolderContracts.LOADING_VERTICAL
) : LoadingListItem {
    override fun itemUniqueIdentifier(): String = "loading"
}
